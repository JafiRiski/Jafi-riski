 ...
 * @author NYOT
 */
public class FXMLkalkulator1Controller implements Initializable {
    ...
    @FXML
    private Button btBukakurung;
    @FXML
    private Button btTutupkurung;
    @FXML
    private Button btAC;
    ...
    private void buttonClicked(ActionEvent event) {
     ...
     if(event.getSource()== btNol){
        ...
        if(event.getSource()==btSatu){
            ...
            Display.setText("");
        }else if(event.getSource()==btBukakurung){
            Display.setText(Display.getText()+"(");
        }else if(event.getSource()==btTutupkurung){
            Display.setText(Display.getText()+")");
